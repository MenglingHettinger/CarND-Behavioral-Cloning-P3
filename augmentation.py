...
path = '/home/mengling/Desktop/'
standard_path = '/home/mengling/Desktop/train05'
recovery_path = '/home/mengling/Desktop/train_curve'
udacity_path = "/home/mengling/Desktop/data"
track2_path = '/home/mengling/Desktop/train04'
img_path = path + '/IMG'
models_path = "./models"
...
def read_img(img_full_path, img_dir="/IMG"):
    ...
    if "train05" in img_full_path:
        prefix_path = standard_path + img_dir
    elif "train_curve" in img_full_path:
        prefix_path = recovery_path + img_dir
    elif "train04" in img_full_path:
